...
void controllerChange(int channel, int number, int value) {
  ...
  if(number == 16) {
     cp5.getController("cantidad").setValue(map(value, 0, 127, 0, 40000)); 
  }
  if(number == 17) {
     cp5.getController("detalle").setValue(map(value, 0, 127, 0, 0.02)); 
  }
  if(number == 18) {
     cp5.getController("velocidad").setValue(map(value, 0, 127, 0, 10)); 
  }
  if(number == 19) {
     cp5.getController("velZ").setValue(map(value, 0, 127, 0, 0.1)); 
  }
  if(number == 20) {
     cp5.getController("alphaColor").setValue(map(value, 0, 127, 0, 255)); 
  }
  if(number == 21) {
     cp5.getController("alphaBack").setValue(map(value, 0, 127, 0, 255)); 
  }
  if(number == 22) {
     cp5.getController("timeLive").setValue(map(value, 0, 127, 0, 20)); 
  }
}