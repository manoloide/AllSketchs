...
void generate() {
  ...
  for (int i = 0; i < c; i++) {
    ...
    if (rnd == 0) {
      ...
      ellipse(xx, yy, ss, ss);
      fill(rcol());
      arc(xx, yy, ss, ss, PI*0.25, PI*1.25);
    ...
    if (rnd == 1) {
      ...
      fill(rcol());
      triangle(xx-ss*0.5, yy-ss*0.5, xx-ss*0.5, yy+ss*0.5, xx+ss*0.5, yy+ss*0.5);
    }
    ...
    if (rnd == 2) {
      ...
      rect(xx-ss*0.5, yy-ss*0.5, ss, ss);
      fill(rcol());
      triangle(xx-ss*0.5, yy+ss*0.5, xx, yy-ss*0.5, xx, yy+ss*0.5);
      fill(rcol());
      triangle(xx+ss*0.5, yy+ss*0.5, xx, yy-ss*0.5, xx, yy+ss*0.5);
      /*
      fill(rcol());
