...
void generate() { 
  ...
  imageMode(CENTER);
  noiseDetail(2);
  int c1 = lerpColor(rcol(), color(random(256)), random(1));
  int c2 = lerpColor(rcol(), color(random(256)), random(1));
  int c3 = lerpColor(rcol(), color(random(256)), random(1));
  int c4 = lerpColor(rcol(), color(random(256)), random(1));
