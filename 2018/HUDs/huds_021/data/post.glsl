...
void main(void) {
    ...
    vec3 sum = mix(col, blur(), 0.9);
    
    float dis = 1.0-pow(clamp(distance(st, vec2(0.5)), 0.0, 1.0), 2.4)*0.01;

    sum = mix(sum, vec3(rand(st*200.0)), 0.03);
    sum = csb(sum, 1.0, 1.4+(1.0-dis)*0.1, 1.1)*dis;
