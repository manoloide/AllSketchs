...
void generate() { 
  ...
  int cw = int(random(12, 20)*20*0.8);//*12.2);//*random(30));
  int ch = int(random(12, 30)*15*0.8);//*12.2);
  float ww = 1./cw;
  float hh = 1./ch;

  float pw1 = random(1, 1.2);
  if (random(1) < 0.5) pw1 = 1./pw1;
  float pw2 = random(1, 1.2);
  if (random(1) < 0.5) pw2 = 1./pw2;

  float ph1 = random(1, 1.2);
  if (random(1) < 0.5) ph1 = 1./ph1;
  float ph2 = random(1, 1.2);
  ...
  float detCol1 = random(0.7, 0.1)*0.1;
  float desCol2 = random(1000);
  float detCol2 = random(0.7, 0.1)*0.1;
  /*
