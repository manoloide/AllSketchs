...
void generate() { 
  ...
  for (int i = 0; i < cirs.size(); i++) {
    ...
    fill(rcol(), 240);
    ellipse(c.x, c.y, c.z*0.6, c.z*0.6);
    fill(255);
...
void screen(float x, float y, float w, float h) {
  float max = random(0.005)*random(0.5, 1);
  float pwr = random(20)*random(1);
  float des1 = random(1000);
  float det1 = random(max);
  float des2 = random(1000);
  float det2 = random(max);
  float des3 = random(1000);
  float det3 = random(max);
  float des4 = random(1000);
  float det4 = random(max);  
