...
PVector dis(float xx, float yy) {
  ...
  float des = ridgedMF(desDes+xx*detDes, seed+desDes+yy*detDes)*160;
...
int colors[] = {#F7C222, #FF3911, #13184C, #5297B7, #EF75BA};
