...
void main(void){
    ...
    vec2 st = vertTexCoord.xy*0.9999;//*(1.0+cos(time)*0.001);
    st.x = st.x+cos(st.y*40.0+time*0.08)*0.003;
    st.y = st.y+cos(st.x*120.0+time*0.09)*0.008;
    
    st.x += cos(time*0.01)*0.0002;
    
    st.x += cos(st.y*6.0+time*0.05)*0.0005;
