...
void generate() {
  ...
  int cw = int(random(80, random(80, 460)));
  int ch = int(max(cw*random(0.01, random(0.1, 1)*random(0.1, 1)), 1));
  float ww = render.width*1./cw;
  float hh = render.height*1./ch;

  float minp = random(1);
  float p1 = randPow(10*random(minp, 1));
  float p2 = randPow(10*random(minp, 1));
  float p3 = randPow(10*random(minp, 1));
  float p4 = randPow(10*random(minp, 1));

  render.noStroke();
  float det1 = random(0.01);
  float det2 = random(0.01);
  PVector p;
  float vc1 = random(2, 5);//random(1000)*random(1);
  float vc2 = random(0.8, 2);//random(1000)*random(1);
