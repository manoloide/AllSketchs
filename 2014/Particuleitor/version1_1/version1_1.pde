/*
-agregar clase input y corregir todo
-revisar la gui y acomodarla
-agregar linea de tiempo
-agregar automatizaciones
-agregar la posibilidad de export secuencia de imagenes
-agregar seed para todo los valores aleatorios
*/
...
void setup() {
  ...
  frame.setTitle(nombre+" "+version);
  gui = new Gui(nombre+" "+version);
